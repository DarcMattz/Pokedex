...
export default function Pokedex() {
  ...
  const [search, setSearch] = useState(""); // Trigger search when clicking button
    ...
    <div className="flex flex-col items-center p-4 bg-gray-100 min-h-screen">
      ...
      <div className="flex space-x-2 mb-4">
        <input
          ...
          className="border p-2 w-64 text-center rounded-lg shadow-sm"
          value={searchInput}
        ...
        <Button
          ...
          className="bg-gradient-to-r px-5 items-center from-cyan-500 to-blue-500 text-white hover:bg-gradient-to-bl focus:ring-cyan-300 dark:focus:ring-cyan-800"
        >
          Search
        </Button>
      </div>
      ...
      {/* Spinner when fetching Pokémon details */}
      ...
      {/* Spinner while loading Pokémon list */}
      {listLoading ? (
